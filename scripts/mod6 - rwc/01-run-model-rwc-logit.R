...
# Jags model
jm <- jags.model(file = "scripts/mod6 - rwc/PV-hyperspec-logit.JAGS",
                 data = dat_list,
                 # inits = inits_list,
                 inits = saved_state[[2]],
                 n.chains = 3)
...
vars <- c("Dsum", "deviance", "R2",
          ...
          "B", "tau", "sig", "tau.logit.rwc", "sig.logit.rwc")
