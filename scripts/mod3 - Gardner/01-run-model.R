...
# saved_state[[1]]
# save(saved_state, file = "scripts/mod3 - Gardner/inits/inits.Rdata")

save(coda_params, file = "scripts/mod3 - Gardner/coda/coda_params.Rdata")
...
save(coda_resid, file = "scripts/mod3 - Gardner/coda/coda_resid.Rdata")
