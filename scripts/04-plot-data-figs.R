...
ggplot() +
  ...
  scale_color_gradient("VPD",
                       high = "coral", low = "mediumblue") +
  scale_shape_manual("Pulse", values = 16:15) +
  theme_bw(base_size = 14) +
  theme(panel.grid = element_blank(),
        strip.background = element_blank())

#### Figure 3: LWP by days since pulse, colored by VPD ####
cde_plot <- cde |> 
...
#### Figure 4: MD vs. PD, colored by VPD ####
